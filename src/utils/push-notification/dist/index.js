...
exports.getScheduledLocalNotifications =
  exports.setPushNotification =
  exports.checkPermissions =
  exports.cancelAllLocalNotifications =
  exports.cancelLocalNotification =
...
var Default = enum_1.eTimestampTypes.Default,
  EveryWeek = enum_1.eTimestampTypes.EveryWeek,
  EveryMonth = enum_1.eTimestampTypes.EveryMonth;
var _a = [Default.toString(), EveryWeek.toString(), EveryMonth.toString()],
  _default = _a[0],
  _everyWeek = _a[1],
  _everyMonth = _a[2];
      ...
      switch (_a.label) {
        case 0:
          result = new Promise(function (resolve) {
            react_native_push_notification_1['default'].checkPermissions(
...
var localNotification = function (params) {
  react_native_push_notification_1['default'].localNotification(
    __assign(__assign({}, params), {channelId: androidChannelId}),
  );
};
...
var getScheduledLocalNotifications = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          result = new Promise(function (resolve) {
            react_native_push_notification_1[
              'default'
            ].getScheduledLocalNotifications(function (notifications) {
...
var cancelLocalNotification = function (id) {
  ...
  react_native_push_notification_1['default'].removeDeliveredNotifications([
    id,
  ]);
};
...
var setPushNotification = function (_a) {
  var itemId = _a.itemId,
    icon = _a.icon,
    triggerState = _a.triggerState,
    itemObj = _a.itemObj,
    dateTime = _a.dateTime,
    appName = _a.appName,
    textState = _a.textState,
    daysState = _a.daysState,
    monthDayState = _a.monthDayState;
  var notifications = [];
  var notifiId = itemId
  ...
  if (triggerState === _default) {
    ...
    var dateTimeList = daysState
      ...
      .map(function (state) {
        return moment_1['default'](dateTime)
          .day(enum_1.eKoDays[state])
          .toDate();
      });
    ...
    if (itemId === null) {
      ...
      var beforeNotiList =
        (itemObj === null || itemObj === void 0
          ? void 0
          : itemObj.notifications) || [];
      beforeNotiList.forEach(function (noti) {
        return cancelLocalNotification(noti._id);
      });
      createEveryWeekNoti(dateTimeList);
    }
