...
var TitleSection_1 = require("../components/section/TitleSection");
...
var MonthSection_1 = require("../components/section/MonthSection");
...
var NotificationScreen = function (_a) {
    ...
    return (react_1["default"].createElement(styled_1.NSafeAreaView, { className: "relative h-full bg-white" },
        ...
        react_1["default"].createElement(styled_1.NScrollView, { className: "p-4 bg-white" },
            react_1["default"].createElement(TitleSection_1["default"], { title: "\uC544\uC774\uCF58", isNotMb: true, component: react_1["default"].createElement(IconView_1["default"], { initialScrollIndex: initialScrollIndex, seletedIcon: iconState, onPress: onPressIcon }) }),
            react_1["default"].createElement(TitleSection_1["default"], { title: "\uB0B4\uC6A9", component: react_1["default"].createElement(styled_1.NTextInput, { className: "h-16 px-5 font-semibold py-3 text-lg leading-[0px] border-2 " + (textState !== '' ? 'border-blue-400' : 'border-gray-200') + " rounded-xl", autoFocus: true, placeholder: t('ex. 할 일, 약속, 스케줄 등'), value: textState, onChangeText: onChangeText }) }),
            react_1["default"].createElement(TitleSection_1["default"], { title: "\uC720\uD615", component: react_1["default"].createElement(styled_1.NView, { className: "flex-row justify-between" }, constants_1.timestampTypes.map(function (info) { return (react_1["default"].createElement(SelectButton_1["default"], { key: info.id, numberType: "odd", id: info.id.toString(), name: info.name, rounded: "rounded-md", selectedId: triggerState, isGap: info.isGap, padding: "p-4", onPress: onPressTriggerButton })); })) }),
            triggerState === Default.toString() && (react_1["default"].createElement(TitleSection_1["default"], { title: "\uB0A0\uC9DC", component: react_1["default"].createElement(DisplayButton_1["default"], { text: moment_1["default"](dateState).format(t(constants_1.formatString.date)), onPress: onPressDateButton }) })),
            triggerState === EveryWeek.toString() && (react_1["default"].createElement(TitleSection_1["default"], { title: "\uC694\uC77C", component: react_1["default"].createElement(styled_1.NView, { className: "flex-row justify-between" }, constants_1.filterDays.map(function (day, idx) { return (react_1["default"].createElement(SelectButton_1["default"], { key: day, id: day, numberType: "odd", name: day, rounded: "rounded-full", selectedId: daysState[idx], isGap: idx !== 0 && idx % 2 !== 0, padding: "p-4", onPress: onPressDay })); })) })),
            triggerState === EveryMonth.toString() && (react_1["default"].createElement(TitleSection_1["default"], { title: "\uC77C", component: react_1["default"].createElement(DisplayButton_1["default"], { text: t('매달') + " " + monthDayState.split('-')[2] + t('일'), onPress: onPressMonthDayButton }) })),
